...
type ThemeColorsBase = Partial<Record<ThemeKey, string[]>>;
...
const DEFAULT_INITIAL_DIMENSION = { height: 200, width: 320 };
...
function LoadingIndicator({ isLoading }: { isLoading: boolean }) {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-20 flex items-center justify-center">
      <div className="text-primary bg-background flex items-center justify-center gap-2 rounded-md border border-border px-2 py-0.5 text-sm">
